...
const locations = [
   ...
   },
   {
      ...
      facility_info_en:
         "Parking adjacent to Danderyds kyrka church in Danderyd.",
   },
   {
   ...
   },
   {
      ...
      facility_info:
         "Parkering vid Hesselmans torg i Sickla Köpkvarter, Nacka.",
      facility_info_en:
         "Parking at Hesselmans torg in Sickla Köpkvarter, Nacka.",
      apps: ["autopay"],
   },
   {
   ...
   },
   {
      ...
      facility_info_en:
         "Parking at Solna Business Park at Smidesvägen in Solna.",
   },
   {
...
const hyrUrls = {
   ...
   Bikupan:
      "https://purchase.park46.se/23/4db5f0a9-a72b-42c3-b012-08d987cb292b",
   Citygaraget:
   ...
   Dalénum:
      "https://purchase.park46.se/23/7439366a-8fa9-4494-bca4-93a93eb0a365",
...
const parkingUrls = {
   ...
   "Sickla Köpkvarter – Atlas Copco":
      "/parking/sickla-kopkvarter-atlas-copco-garaget/",
   "Sickla Köpkvarter – Avlånga P-huset": "/parking/sickla-icagaraget/",
   "Sickla Köpkvarter – Front II":
      "/parking/sickla-kopkvarter-sickla-front-ll/",
...
function shortPriceLine(line) {
   ...
   s = s.replace(
      /(\d+)\s*timmars?\s*fri parkering per dag/gi,
      "$1h gratis/dag",
   );
         ...
         subEl.querySelectorAll(".loc-item").forEach((el) => {
            ...
            const textMatch =
               ...
               (locations[i].name + " " + locations[i].addr)
                  ...
                  .includes(term);
            const filterMatch =
               sidebarFilter === "all" || !!hyrUrls[locations[i].name];
...
function setSidebarFilter(mode) {
   ...
   document
      .getElementById("filter-hyr")
      ?.classList.toggle("active", mode === "hyr");
...
function selectLocation(i) {
   ...
   const facilityInfoWrap = document.getElementById(
      "detail-facility-info-wrap",
   );
   ...
   if (chipsEl) {
      chipsEl.innerHTML = chipsData
         .map(
            (c) =>
               `<div class="detail-chip">${c.icon}<span>${c.line}</span></div>`,
         )
         .join("");
   }
   ...
   function renderResults(q) {
      ...
      box.querySelectorAll(".search-result-item").forEach((el) => {
         ...
         el.addEventListener("mouseenter", () => {
            box.querySelectorAll(".search-result-item").forEach((x) =>
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   if (document.getElementById("location-list")) {
      ...
      document
         .getElementById("filter-all")
         ?.classList.toggle("active", sidebarFilter === "all");
      document
         .getElementById("filter-hyr")
         ?.classList.toggle("active", sidebarFilter === "hyr");
